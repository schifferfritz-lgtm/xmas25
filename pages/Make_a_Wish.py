...
col3.badge(f"Selected Date: {event_date}", icon=":material/event_available:", color=musicals[st.session_state['selected_musical']]['colour'])
col4.badge(f"Selected Time: {event_time}", icon=":material/alarm_on:", color=musicals[st.session_state['selected_musical']]['colour'])
